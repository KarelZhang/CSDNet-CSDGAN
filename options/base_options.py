...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--network_model', type=str, default='normal', help='selects model to use for netG')
        ...
        self.parser.add_argument('--patchD_3', type=int, default=1, help='choose the number of crop for patch discriminator')
        ...
        self.parser.add_argument('--stages', type=int, default=3, help='use light data augmentation')
        self.parser.add_argument('--lighten', action='store_true', help='normalize attention map')
        self.parser.add_argument('--use_edge', action='store_true', help='use edge')
